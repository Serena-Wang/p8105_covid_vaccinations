...
Since we aim to characterize the trends of first infections and reinfections in NYC, we filter "New York City" in `redc_region` column. And here are the definition of major variables.
