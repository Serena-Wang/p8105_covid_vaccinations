...
Since we aim to characterize the trends of first infections and reinfections in NYC, we filter "New York City" in redc_region column. And here are the defination of major variables.
...
To better compare the trends of these health outcomes(reinfections/hospitalizations/deaths), we broke down days by weeks. After that, we combined 2 datasets (Hospitalization and Death Data/Reinfection Data) 
