...
H0: the mean vaccination rates are the same across all boroughs.

H1: the mean vaccination rate are not same across all boroughs.
...
H0: the mean vaccination rates are the same across all races.

H1: the mean vaccination rates are not same across all races.
...
H0: the mean vaccination rates are the same across genders.

H1: the mean vaccination rates are not same across all genders.
...
We predicted that there is no difference in vaccination rate in NYC across different age groups. We will perform the chi-square test to verify our assumption.

H0: the mean vaccination rates are the same across age groups.

H1: the mean vaccination rate are not same across age groups.
